...
public class UserLogin
{
    ...
    [StringLength(30, ErrorMessage = "The login must be between 4 and 30 characters long and must start with a letter and end with a letter or number. May contain a floor and a dash between the start and end.", MinimumLength = 4)]
    ...
    [StringLength(40, ErrorMessage = "Password must be between 8 and 40 characters long and contain at least one lowercase letter, one uppercase letter, one number and one special character.", MinimumLength = 8)]
